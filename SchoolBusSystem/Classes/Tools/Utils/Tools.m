...
//    CLLocationCoordinate2D coor = [Tools transformFromWGSToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
//    return [[Tools alloc] initWithLatitude:coor.latitude andLongitude:coor.longitude];
//}
//
//- (id)transformFromGDToBD {
//    CLLocationCoordinate2D coor = [Tools transformFromGCJToBaidu:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
//    return [[Tools alloc] initWithLatitude:coor.latitude andLongitude:coor.longitude];
//}
//
//- (id)transformFromBDToGD {
//    CLLocationCoordinate2D coor = [Tools transformFromBaiduToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
//    return [[Tools alloc] initWithLatitude:coor.latitude andLongitude:coor.longitude];
//}
//
//- (id)transformFromGDToGPS {
//    CLLocationCoordinate2D coor = [Tools transformFromGCJToWGS:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
//    return [[Tools alloc] initWithLatitude:coor.latitude andLongitude:coor.longitude];
//}
//
//- (id)transformFromBDToGPS {
//    //先把百度转化为高德
//    CLLocationCoordinate2D start_coor = [Tools transformFromBaiduToGCJ:CLLocationCoordinate2DMake(self.latitude, self.longitude)];
//    CLLocationCoordinate2D end_coor = [Tools transformFromGCJToWGS:CLLocationCoordinate2DMake(start_coor.latitude, start_coor.longitude)];
//    return [[Tools alloc] initWithLatitude:end_coor.latitude andLongitude:end_coor.longitude];
//}

...
- (instancetype)initWithTitle:(NSString *)title cancelButtonTitle:(NSString *)cancelButtonTitle destructiveButtonTitle:(NSString *)destructiveButtonTitle otherButtonTitles:(NSArray *)otherButtonTitles handler:(LPActionSheetBlock)actionSheetBlock
{
    ...
    if (self)
    {
        ...
        if (title && title.length > 0)
        {
            ...
            titleLabel.textColor = [UIColor colorWithRed:175.0f/255.0f green:175.0f/255.0f blue:175.0f/255.0f alpha:1.0f];
        ...
        if (destructiveButtonTitle && destructiveButtonTitle.length > 0)
        {
            ...
            [destructiveButton setTitleColor:[UIColor colorWithRed:244.0f/255.0f green:51.0f/255.0f blue:60.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
        ...
        if (cancelButtonTitle && cancelButtonTitle.length > 0)
        {
            ...
            [cancelButton setTitleColor:[UIColor colorWithRed:51.0f/255.0f green:51.0f/255.0f blue:51.0f/255.0f alpha:1.0f] forState:UIControlStateNormal];
